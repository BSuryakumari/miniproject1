...
class UserPostItem extends Component {
  ...
  render() {
    ...
    const {UserPostDetails} = this.props
    const {createdAt, likesCount, profilePic, userId, userName, postDetails} =
      UserPostDetails
      ...
      <li className="userPost-item-li-container">
        ...
        <div className="like-comment-share-container">
          {isLiked ? (
            ...
            >
              <FcLike className="userPost-interaction-button" testid="unLikeIcon"/>
            </button>
          ) : (
          ...
          <button type="button">
            <FaRegComment
              className="userPost-interaction-button"
              testid="searchIcon"
            />
          </button>
          <button type="button">
